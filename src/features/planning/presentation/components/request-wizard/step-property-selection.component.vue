...
<template>
  <div class="step-property">
    ...
    <div v-if="store.isLoading" class="step-property__loading">
      <div class="step-property__grid">
        <pv-skeleton width="100%" height="80px" borderRadius="12px" />
        <pv-skeleton width="100%" height="80px" borderRadius="12px" />
      </div>
    </div>
    <div v-else class="step-property__grid">
      <div
      ...
      <div v-if="!properties.length" class="step-property__empty">
...
.step-property__loading { margin-bottom: 1rem; }
...
.step-property__empty { text-align: center; padding: 2rem; color: var(--el-warm-gray); }
